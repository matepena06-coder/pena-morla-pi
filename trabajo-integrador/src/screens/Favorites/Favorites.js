...
class Favorites extends Component{
  ...
  eliminarFavorito(id){
   ...
   render(){
      ...
      //Separo peliculas y series de esta manera porque las peliculas tienen title y las series name
      ...
      return(
          ...
          <React.Fragment>
              ...
              {peliculasFavoritas.length === 0 ?(
                  ...
                  //botonesFavoritos sirve para que solo aparezca el boton de eliminar en favoritos
              ))
              )}
              </section>
